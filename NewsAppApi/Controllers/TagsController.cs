...
namespace NewsAppApi.Controllers
{
    ...
    public class TagsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetPaged(
            ...
            [FromQuery] string? sortBy = null,        // name|id
        ...
        [HttpGet]
        public async Task<IActionResult> GetPaged([FromQuery] TagFilter filter)
        {
        ...
        [HttpGet("export")]
        public async Task<IActionResult> Export([FromQuery] TagFilter filter)
        {
            var csv = await _svc.ExportCsvAsync(filter);
            var fileName = $"tags_{DateTime.UtcNow:yyyyMMdd_HHmmss}.csv";
